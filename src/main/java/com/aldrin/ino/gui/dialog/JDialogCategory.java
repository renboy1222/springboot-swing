...
public class JDialogCategory extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogCategory(com.aldrin.ino.gui.JFrameInoPOS parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(688, 525));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String title = "New";
        JDialogAUCategory auUser = new JDialogAUCategory(mainForm, true, title);
    ...
    private void jTableUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableUserMouseClicked
        ...
        this.category.setCategory(firstnamel);
        this.category.setDescription(lastnamel);

    }//GEN-LAST:event_jTableUserMouseClicked

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        String title = "Update";
        JDialogAUCategory auUser = new JDialogAUCategory(mainForm, true, title, category);
        auUser.setVisible(true);
        selectCategory();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        String title = "Delete";
        JDialogAUCategory auUser = new JDialogAUCategory(mainForm, true, category, title);
        auUser.setVisible(true);
        selectCategory();
        jButtonUpdate.setEnabled(false);
        jButtonDelete.setEnabled(false);
...
//            hidden4.setMaxWidth(0);
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String categoryl = String.valueOf(jTableUser.getValueAt(row, 1).toString());
                        String descriptionl = String.valueOf(jTableUser.getValueAt(row, 2).toString());

                        Category c = new Category(idl, categoryl, descriptionl);
                        this.category = c;
    ...
    private void selectCategory() {
        List<Category> list = categoryDAO.listOfUser();
